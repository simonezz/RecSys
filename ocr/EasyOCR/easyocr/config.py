...
model_url = {
    ...
    'latin.pth': (
    'https://github.com/JaidedAI/EasyOCR/releases/download/pre-v1.1.6/latin.zip', 'fb91b9abf65aeeac95a172291b4a6176'),
    'chinese.pth': (
    'https://github.com/JaidedAI/EasyOCR/releases/download/pre-v1.1.6/chinese.zip', 'dfba8e364cd98ed4fed7ad54d71e3965'),
    ...
    'korean.pth': (
    'https://github.com/JaidedAI/EasyOCR/releases/download/pre-v1.1.6/korean.zip', '45b3300e0f04ce4d03dda9913b20c336'),
    'thai.pth': (
    'https://github.com/JaidedAI/EasyOCR/releases/download/pre-v1.1.6/thai.zip', '40a06b563a2b3d7897e2d19df20dc709'),
    ...
    'arabic.pth': (
    'https://github.com/JaidedAI/EasyOCR/releases/download/pre-v1.1.6/arabic.zip', '993074555550e4e06a6077d55ff0449a'),
    'tamil.pth': (
    ...
    'telugu.pth': (
    'https://github.com/JaidedAI/EasyOCR/releases/download/v1.2/telugu.zip', 'f7576012a3abe593950c47bfa1bd8ddc'),
    'kannada.pth': (
    'https://github.com/JaidedAI/EasyOCR/releases/download/v1.21/kannada.zip', 'c240c97e4adb8773b53b3b3dec728627'),
}
